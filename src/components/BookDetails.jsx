...
const BookDetails = () => {
    ...
    return (
        <div className="bg-[#f3f3f3]">
            <div className='container mx-auto py-12 px-5 lg:px-0 text-gray-800'>

                <h1 className="text-4xl font-semibold text-center mb-12 ">Book Details</h1>

                <div className="mb-12">
                    <Link to={`/books/${category}`} className="flex items-center gap-2 text-2xl lg:text-3xl font-normal font-['Rancho']">
