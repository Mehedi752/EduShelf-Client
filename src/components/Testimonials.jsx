...
const Testimonials = () => {
    return (
        <div className="py-12 bg-[#f3f3f3] my-12">
            <div className="container mx-auto px-5 lg:px-0">
                <motion.h2
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
                    className="text-3xl lg:text-4xl font-semibold text-center mb-10 text-gray-800"
                >
                    What Our Users Say
                </motion.h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((testimonial) => (
                        ...
                        >
                            ...
                            />
                            <h3 className="text-xl font-semibold text-blue-300">{testimonial.name}</h3>
